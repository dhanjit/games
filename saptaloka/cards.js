...
const ENDINGS = {
  ...
  false_karma: { kind: "falsesummit", title: "Svarga", deva: "स्वर्ग",
    lie: "Your merit ripens and the gates of Svarga open in light.",
  ...
  false_bhakti: { kind: "falsesummit", title: "Deva", deva: "देव",
    lie: "Devotion crowns you a god — temples bear your face, the lamps never dim.",
...
const CARDS = [
  ...
  c('beggar_blessing', {
    ...
    right: { label: 'Ask for power',    fx: { tejas: +10, bhakti: -6, karma: -4 },
             outcome: 'You ask the deva you once fed to repay you in fire, not grace. He grants it — but the warmth he meant for you curdles into something colder.' },
  }),
  ...
  c('beggar_spurned', {
    ...
    left:  { label: 'Kneel and atone', fx: { prana: -7, karma: +6, bhakti: +4 },
             outcome: 'You kneel before the god you once stepped over, and the merit that leaned away comes slowly back — paid for now in aching knees.' },
    right: { label: 'Step over him again', fx: { tejas: +4, karma: -9, bhakti: -4 },
             outcome: 'Twice now you have stepped over the god in rags. The second scorn cuts deeper than the first — the ledger darkens where you would not look.' },
  }),
  ...
  c('bride_queen', {
    ...
    left:  { label: 'Bless her, take nothing', fx: { karma: +6, bhakti: +6, tejas: -2 },
             outcome: 'The frightened girl you hid for one night now wears a crown, and asks nothing of you but a blessing. You give it freely, and the mercy ripens whole.' },
    right: { label: 'Accept her treasury',     fx: { tejas: +8, karma: -5, prana: +4 },
             outcome: 'The bride you once sheltered would repay you, and you take the gold she offers. The night of mercy is spent now, weighed out in coin.' },
  }),
  ...
  c('bride_pyre', {
    ...
    left:  { label: 'Grieve, chant her name', fx: { prana: -6, bhakti: +6, karma: +4 },
             outcome: 'You chant for the bride you turned away, the one night you would not give her now mourned across many. Grief is its own slow atonement.' },
    right: { label: '"It was not my burden."', fx: { tejas: +5, karma: -8, bhakti: -4 },
             outcome: 'You name the girl you sent back to the pyre as no concern of yours, and turn from her shade. The denial settles cold and heavy on your deeds.' },
  }),
  ...
  c('child_grown', {
    ...
    left:  { label: 'Walk together a while', fx: { prana: +8, bhakti: +5, tejas: -2 },
             outcome: 'The child you descended the well to save walks beside you, grown and grateful. The breath you spent in that dark is returned to you, doubled.' },
    right: { label: 'Send him to his own path', fx: { karma: +5, tejas: +2, prana: -2 },
             outcome: 'You loose the grown child to walk his own road, asking nothing back for the descent into the well. The old mercy stands clean and complete.' },
  }),
  ...
  c('well_demon', {
    ...
    right: { label: 'Flee, as you taught her', fx: { prana: -4, karma: -8, tejas: +2 },
             outcome: 'You flee the demon you once left below, just as you taught the child to flee her mother. The cowardice you planted comes back full-grown.' },
  }),
  ...
  c('soldier_spirit', {
    ...
    left:  { label: 'Receive his peace',      fx: { prana: +7, bhakti: +5, karma: +3 },
             outcome: 'You buried his blade rather than spill more blood, and now his quiet spirit returns the kindness — peace flows into your weary limbs.' },
    right: { label: 'Ask him to fight once more', fx: { tejas: +7, karma: -6, prana: -3 },
             outcome: 'You ask the spirit you laid to rest to take up war again, undoing the mercy of his burial. He obeys, and the broken peace costs you.' },
  }),
  ...
  c('sword_reckoning', {
    ...
    left:  { label: 'Keep the broken oath',   fx: { prana: -12, tejas: +6, karma: -6 },
             outcome: 'You took the dying man\'s blade and swore it to the side he betrayed — then kept it for yourself. The wronged come now to collect the broken vow in blood.' },
    right: { label: 'Lay it down, atone',     fx: { prana: -4, karma: +7, bhakti: +4, tejas: -3 },
             outcome: 'You lay down the soldier\'s blade before those it once betrayed, honoring at last the oath you took with it. The long debt of carrying it is settled.' },
  }),
  ...
  c('priest_honor', {
    ...
    left:  { label: 'Accept it humbly',   fx: { bhakti: +8, karma: +4, tejas: -2 },
             outcome: 'You turned the thief from the god\'s feet and asked nothing; now the deity speaks your name with love, and you receive the honor with bowed head.' },
    right: { label: 'Demand a boon in return', fx: { tejas: +6, bhakti: -6, karma: -3 },
             outcome: 'You guarded the shrine for nothing once, and now demand its price — turning a freely-given honor into a bargain. The deity\'s warmth withdraws.' },
  }),
  ...
  c('temple_wrath', {
    ...
    left:  { label: 'Confess, restore it', fx: { prana: -8, karma: +7, bhakti: +3 },
             outcome: 'You confess that you kept watch while the shrine was robbed, and labor to restore what was taken. The stolen merit is repaid, dearly but in full.' },
  ...
  // ---------- THE OFFER (a false summit, made a choice) ----------
  // tag:'offer' + stat: never in the pool. When karma or bhakti first crosses 85 in
  // a run, the next draw is that stat's offer (commitChoice queues it, drawNextCard
  // serves it); until it resolves, that stat can't end the run by overshooting 100.
  // fx here are placeholders — game.js builds them at draw time from the live value
  // (refuse: back to 75; accept: up to 100) so Sage's Eye can preview both. `accept`
  // names the ending, which endRun stages as a win before the reveal.

  c('offer_svarga', {
    tag: 'offer', stat: 'karma',
    art: '🌅', speaker: 'The gatekeeper of Svarga',
    text: '"Your ledger is heavy with merit — enough to buy a seat among the devas. Stay. Rule here. The climb is long, and this is already heaven."',
    left:  { label: 'Turn from the gates', fx: {},
             outcome: 'You turn from the open gates of Svarga. The merit that opened them is spent on the turning, and the climb is long — but the road above is still yours.' },
    right: { label: 'Stay. Rule here.',    fx: {}, accept: 'false_karma' },
  }),

  c('offer_deva', {
    tag: 'offer', stat: 'bhakti',
    art: '🛕', speaker: 'Your first worshipper',
    text: '"They are building you a temple. I carried the first stone myself. Sit — let us garland you, let us light the lamps. A god does not need to climb."',
    left:  { label: 'Send them home', fx: {},
             outcome: 'You send your worshipper home with the stone still in his hands. The devotion that would have enthroned you goes cold, and the climb bites where a god would feel nothing — but you remain a climber, not an idol.' },
    right: { label: 'Be enthroned',   fx: {}, accept: 'false_bhakti' },
  }),
